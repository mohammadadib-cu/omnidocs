...
\begin{table}
	\caption[Arrhenius rate coefficients of the surface reactions in HACA, $k=AT^n\cdot e^{-E/RT}$]{Arrhenius rate coefficients of the surface reactions in HACA~\citep{appel2000kinetic}, $k=AT^n\cdot e^{-E/RT}$.}
	\label{tab:HACA}
	\centering
