...
\begin{figure}[H]
	...
	\caption{The schematics of (a) constant volume reactor, (b) constant pressure reactor, (c) perfectly stirred reactor, and (d) plug flow reactor.}
	\label{fig:reactors} 
\end{figure}
