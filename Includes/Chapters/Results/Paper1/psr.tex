...
\begin{figure*}[!t]
	\centering
	\begin{tikzpicture}
		\draw (0, 0) node[inner sep=0] 	{\includegraphics[width=1\textwidth]{Figures/Results/Paper1/PSR/PSD_eq_ratio_log.pdf}};
	...
	\end{tikzpicture}
	\caption[The particle size distribution at the end of PFR, and the mole fraction of A2R5, and inception flux, $I_{inc}$ along the PFR for (a, d) $\phi=1.9$, (b, e) 2.0, and (c, f) 2.1 obtained using KAUST mechanism, SPBM and different inception models calibrated to match the predictions with the PSD measurements.]{The particle size distribution at the end of PFR, and the mole fraction of A2R5, and inception flux, $I_{inc}$ along the PFR for (a, d) $\phi=1.9$, (b, e) 2.0, and (c, f) 2.1 obtained using KAUST mechanism, SPBM and different inception models calibrated to match the predictions with the PSD measurements~\citep{manzello2007soot}.}
...
\begin{table}[!t]
	\centering
	\caption[The geometric mean mobility diameter, $d_{m,g}$, and the geometric mobility standard deviation, $\sigma_{m,g}$, obtained using different inception models compared with the value calculated from the measured PSD.]{The geometric mean mobility diameter, $d_{m,g}$, and the geometric mobility standard deviation, $\sigma_{m,g}$, obtained using different inception models compared with the value calculated from the measured PSD~\citep{manzello2007soot}.}
...
\begin{figure*}[!t]
	...
	\caption[The primary particle diameter, $d_p$, the total surface growth rate by HACA and PAH adsorption, and the soot volume fraction, $f_{v}$ along the PFR for (a, d) $\phi=1.9$, (b, e) 2.0, and (c, f) 2.1 obtained using KAUST mechanism, SPBM and different inception models calibrated to match the predictions with the PSD measurements.]{The primary particle diameter, $d_p$, the total surface growth rate by HACA and PAH adsorption, and the soot volume fraction, $f_{v}$ along the PFR for (a, d) $\phi=1.9$, (b, e) 2.0, and (c, f) 2.1 obtained using KAUST mechanism, SPBM and different inception models calibrated to match the predictions with the PSD measurements~\citep{manzello2007soot}.}
	\label{fig:psrpfr_fv} 
\end{figure*}
