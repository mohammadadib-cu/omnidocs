...
\begin{figure}[!t]
	...
	\caption{
    Variation in predicted temperature at 0.5 ms for 5\%, 10\% and 30\% loadings over the studied T$_5$ range. Error bars and shaded regions represent the spread in predictions from four employed kinetic models.}
