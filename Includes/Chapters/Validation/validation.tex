...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}
		\draw (0, 0) node[inner sep=0] 	{\includegraphics[width=0.65\textwidth]{Figures/Results/Validation/Kernel/kernel_valid.pdf}};
	\end{tikzpicture}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{Figures/Results/Validation/ConstUV/relerr_constuv.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{Figures/Results/Validation/IPR/relerr_pressure.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{Figures/Results/Validation/PSR/relerr_psr.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{Figures/Results/Validation/PFR/relerr_pfr.pdf}
