...
%----------------------------------------------------
% Species without soot modeling

% CH4
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{Figures/Results/Shocktube/30CH4/CH4_all.pdf}
	\caption{The time history of $\mathrm{CH_4}$ mole fraction of 30\% $\mathrm{CH_4}$ pyrolysis for 1861 K$<\mathrm{T}<$2455 K using Caltech, KAUST, ABF, and K-FFCM2 mechanisms without soot compared with laser diagnostic data}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{Figures/Results/Shocktube/30CH4/C2H4_all.pdf}
	\caption{The time history of $\mathrm{C_2H_4}$ mole fraction of 30\% $\mathrm{CH_4}$ pyrolysis for 1861 K$<\mathrm{T}<$2455 K using Caltech, KAUST, ABF, and K-FFCM2 mechanisms without soot compared with laser diagnostic data}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{Figures/Results/Shocktube/30CH4/C2H2_all.pdf}
	\caption{The time history of $\mathrm{C_2H_2}$ mole fraction of 30\% $\mathrm{CH_4}$ pyrolysis for 1861 K$<\mathrm{T}<$2455 K using Caltech, KAUST, ABF, and K-FFCM2 mechanisms without soot compared with laser diagnostic data}
...
\subsection{10\% $\mathrm{CH_4}$ dataset}
...
% Soot properties using optimized PAH growth models
\begin{figure}[H]
	\centering
